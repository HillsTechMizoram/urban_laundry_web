                            ...
                            <div class="col-xl-12 stretch-card grid-margin">
                                <div class="card">
                                    ...
                                    ?>
                                        ...
                                        <form method="post" class="pt-4 pl-2 pr-2" name="changepassword" onsubmit="return checkpass();">
                                        ...
                                        <?php } ?>
                                        <p style="text-align: center; "><button type="submit" name="submit" class="btn btn-primary btn-min-width mr-1 mb-1">Change</button></p>
                                        </form>
                                </div>
                            </div>
                        </div>
