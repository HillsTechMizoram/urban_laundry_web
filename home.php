...
<head>
  <title>Urban Laundary Management System</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <hr>
        <p>Laundary Management System (LMS) Developed in PHP and Mysql </p>
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © Laundary Management System (LMS) 2019</span>
          </div>
        </div>
      </footer>
