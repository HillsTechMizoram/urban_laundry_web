        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/img/logo/wash.gif" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="main-header header-sticky">
                ...
                <div class="header-left">
                    <div class="logo">
                        <a href="index.php">
                            <h1>URBAN LAUNDRY</h1>
                            <h5>Industrial laundry & dry clean </h5>
                ...
                <div class="header-right d-none d-lg-block">
                    <a href="#" class="header-btn1"><img src="assets/img/icon/call.png" alt=""> (+91) 897 478 4805</a>
                    <a href="user" class="header-btn2">Make an Appointment</a>
                </div>
                <!-- Mobile Menu -->
                <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-9 col-md-10 col-sm-9">
                                <div class="hero__caption">
                                    ...
                                    <a href="user" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">Customer Login</a>
                                </div>
                            </div>
                        </div>
                    </div>
